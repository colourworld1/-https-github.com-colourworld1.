...
<p class="text-center m-2" Style="font-size:13px; color: Black;">Minimmum Withdrawal is Now 330 Rs</p>
    ...
    <a href="addupidetail.php" class="text-danger"><i class="fa fa-plus"></i> Add UPI ID</a>
      ...
      <i class="icon ion-md-card"></i>
        <select class="form-control select2" name="acid" id="acid" style="padding-left:40px;">
